    ...
    <div className="flex flex-col gap-6">
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div>
          ...
          <p className="mt-1 text-muted-foreground text-sm">
            Live platform stats from Django analytics dashboard.
          </p>
        </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <StatCard
          ...
          subtitle={
            stats
              ? `${stats.users.recent_signups_30d.toLocaleString()} new in 30d`
              : undefined
          }
          icon={Users}
        ...
        <StatCard
          ...
          subtitle={
            content ? `${content.civic_chapters.toLocaleString()} chapters` : undefined
          }
          icon={GraduationCap}
        ...
        <StatCard
          ...
          subtitle={
            engagement ? `${engagement.forum_posts.toLocaleString()} posts` : undefined
          }
          icon={MessageSquare}
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <StatCard
          ...
          value={
            engagement
              ? `${engagement.trivia_sets} / ${engagement.surveys}`
              : "0 / 0"
          }
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        />
        <StatCard
          title="Pageviews (snapshot)"
          value={stats?.snapshot.total_pageviews ?? 0}
          subtitle={
            stats?.snapshot.date
              ? `${stats.snapshot.unique_visitors.toLocaleString()} unique · ${stats.snapshot.date}`
