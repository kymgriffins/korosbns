...
export const metadata: Metadata = buildPageMetadata({
  ...
  description:
    "Explore our flagship initiatives including Project One: Project TERRA with House of Fiscal Wisdom, Budget Literacy, County Tracking, and Public Participation Hubs.",
  path: "/bns-project",
  keywords: [
    "Project TERRA",
