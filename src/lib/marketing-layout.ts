...
/**
 * Partner homepage hero is full-bleed 100dvh under a fixed nav.
 * Skip main `pt-*` offset so padding does not stack under the reel.
 */
export function usesFullBleedHero(pathname: string): boolean {
