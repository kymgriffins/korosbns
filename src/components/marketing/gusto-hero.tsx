            ...
            <Container size="ultra" className="relative z-20">
                <motion.div style={{ opacity }} className="flex flex-col items-center text-center">
                    ...
                    <motion.h1
                        ...
                        className="g-display text-white mb-8 max-w-4xl tracking-[-0.03em]"
                    >
                    ...
                    >
                        <Link href="/learn">
                            <Button size="lg" className="rounded-full px-10 h-16 text-lg bg-white text-black hover:bg-white/90 transition-all hover:scale-[1.02] active:scale-95 shadow-premium font-bold">
                                Explore Stories
                                <ArrowRightIcon className="ml-3 w-5 h-5" />
                            </Button>
                        </Link>
                        <Link href="/research">
                            <Button size="lg" variant="outline" className="rounded-full px-10 h-16 text-lg border-white/20 text-white hover:bg-white/10 transition-all hover:scale-[1.02] active:scale-95">
                                Dive into Data
                            </Button>
                        </Link>
                    </motion.div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-12 md:gap-20 pt-20 border-t border-white/5 w-full max-w-5xl">
                        {[
                            ...
                            >
                                ...
                                <p className="g-mono text-[11px] text-white/30 tracking-[0.4em] uppercase whitespace-nowrap">
                                    {stat.label}
                                </p>
                            </motion.div>
                        ))}
