...
export const MEGA_MENU_DATA: MegaMenuSection[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        description: "Commissioned storytelling, animations & documentaries.",
        icon: Clapperboard,
        badge: "Impact Media",
      },
    ],
  },
  {
    ...
    featured: {
      ...
      description: "Operating studio surplus directly supports grassroots budget tracking.",
      badge: "Civic Model",
      href: "/programmes/studios",
    },
    items: [
      {
        title: "Reel & Formats",
        href: "/programmes/studios#studio-formats",
        description: "Documentaries, podcasts, and visual explainers.",
        icon: Clapperboard,
        badge: "Formats",
      },
      {
        title: "Featured Work",
        href: "/programmes/studios",
        description: "Commissioned campaigns across partners.",
        icon: Flame,
        badge: "Portfolio",
      },
      {
        ...
        href: "/programmes/studios",
        description: "Mission-aligned production house with nationwide reach.",
        icon: ShieldCheck,
        badge: "About",
      },
      {
        ...
        description: "Book our team for your next media project.",
        icon: Send,
        badge: "Hire Us",
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        description: "How investigative data transforms into citizen power.",
        icon: Zap,
        badge: "Impact",
      },
      {
        ...
        description: "Primary source verification and non-partisan rigor.",
        icon: ShieldCheck,
        badge: "Ethics",
      },
      {
        ...
        href: "/about#team",
        description: "Meet the researchers, journalists, and founding allies.",
        icon: Users,
        badge: "People",
      },
    ],
