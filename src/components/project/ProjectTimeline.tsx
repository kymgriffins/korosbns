...
const projectMilestones: Record<string, Milestone[]> = {
  "budget-literacy": [
    ...
    { date: "Q3 2025", title: "Kiswahili Modules", description: "Kiswahili translations are planned; published learning modules are currently English-first.", status: "upcoming" },
...
const defaultMilestones: Milestone[] = [
  ...
  { date: "Q3 2025", title: "Multilingual Content", description: "UI chrome supports language switching; full Kiswahili module bodies are not yet complete — English remains the published content language.", status: "in_progress" },
