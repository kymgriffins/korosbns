...
const projectMilestones: Record<string, Milestone[]> = {
  "budget-literacy": [
    ...
    { date: "Q2 2024", title: "First Module Launch", description: "Launched the inaugural 'Budget 101' interactive module reaching 5,000+ citizens in the first month.", status: "completed" },
    ...
    { date: "Q1 2025", title: "School Partnerships", description: "Partnered with 15 universities and colleges to integrate budget literacy into civic education curricula.", status: "completed" },
  ...
  "county-budget-tracking": [
    ...
    { date: "Q3 2024", title: "Pilot Counties", description: "Launched pilot tracking in 5 counties: Nairobi, Kisumu, Mombasa, Nakuru, and Uasin Gishu.", status: "completed" },
    ...
    { date: "Q2 2025", title: "20-County Expansion", description: "Expanded tracking coverage to 20 counties through partnerships with civil society organizations.", status: "completed" },
  ...
  "public-participation": [
    ...
    { date: "Q2 2025", title: "Finance Bill 2025", description: "Guided 2,000+ citizens through submitting memoranda on the Finance Bill 2025 via the platform.", status: "completed" },
