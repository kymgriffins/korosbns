...
export function ProgrammeDetail({ programme }: { programme: ProgrammeBlock }) {
  return (
    <div className="w-full bg-background">
      <section className="relative min-h-[75svh] overflow-hidden border-b border-border/40 md:min-h-[90svh]">
        <Image
        ...
        <div className="relative z-10 mx-auto flex min-h-[75svh] max-w-[1400px] flex-col justify-end px-6 pb-14 pt-28 md:min-h-[90svh] md:px-16 md:pb-20">
          <motion.div
          ...
          >
            ...
            <motion.p variants={fadeInUp} className="text-sm font-medium text-foreground/70">
              {programme.eyebrow}
            </motion.p>
      ...
      {/* Contact sheet of programme photography */}
      <div className="mx-auto grid max-w-[1400px] grid-cols-3 gap-2 px-6 py-4 md:gap-3 md:px-16 md:py-6">
